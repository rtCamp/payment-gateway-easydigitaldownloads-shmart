...
# main config
export PLUGINSLUG="payment-gateway-easy-digital-downloads-shmart"  #must match with wordpress.org plugin slug
export MAINFILE="edd-shmart.php" # this should be the name of your main php file in the wordpress plugin
